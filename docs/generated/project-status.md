...
| 65 | PGSTAT-P1-021 | P1 | collector | in_progress | pg_stat_statements sorgusu extension surumune degil sunucu surumune gore seciliyordu | Kalan M1 kapsami: pgss extversion merkezi kayda yazilsin; erisilebilir veritabanlarinda extension varligi/surumu/okuma yetkisi kesfedilsin ve secilen toplama veritabani kaydedilsin; durumlar ayrilsin (unsupported/not_installed/permission_denied/version_incompatible/version_unknown/available/collection_failed); last_error_text basarida temizlensin. |
