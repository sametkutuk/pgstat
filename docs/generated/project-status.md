...
| 65 | PGSTAT-P1-021 | P1 | collector | in_progress | pg_stat_statements sorgusu extension surumune degil sunucu surumune gore seciliyordu | Kalan: AC7 gercek PostgreSQL test matrisi (pgss 1.8/1.9/1.10/guncel + yalniz appdb + 42501) ve AC12 to_jsonb maliyeti olcumu. AC5 deploy sonrasi db1.dc-etstur.com-test uzerinde pgss_collection_dbname=etstur ve statements akisiyla canlida dogrulanmali. |
