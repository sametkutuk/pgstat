...
| 65 | PGSTAT-P1-021 | P1 | collector | in_progress | pg_stat_statements sorgusu extension surumune degil sunucu surumune gore seciliyordu | Dis inceleme uc bloklayici doğruluk hatasi buldu, ucu de duzeltildi ve gercek PG17 de dogrulandi. Kalan M1: extversion merkezi kayda, veritabanlari arasi kesif, durum modeli. Kalan katalog isleri: fail-fast dogrulama (AC11), to_jsonb maliyeti (AC12), PG18 olcumu (AC13), catalog_version kaniti (AC14). |
