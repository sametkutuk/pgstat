...
| 65 | PGSTAT-P1-021 | P1 | collector | in_progress | pg_stat_statements sorgusu extension surumune degil sunucu surumune gore seciliyordu | AC14 sirada: catalog_version runtime da gercekten tuketilsin/dogrulansin; availableCapabilities(null) bos kume donsun veya sonuc unknown olarak modellensin; bilinmeyen surum hicbir yetenek icin available sayilmasin; guvenli projection ile yetenek uygunlugu ayrilsin - sorgunun calisabilmesi, yetenegin kanitlanmis olmasi demek degil. Kalan: AC5, AC7, AC12. |
