...
| 65 | PGSTAT-P1-021 | P1 | collector | in_progress | pg_stat_statements sorgusu extension surumune degil sunucu surumune gore seciliyordu | AC4 ve AC6 bitti (extversion + tipli durum kaniti, V119). Deploy sonrasi pgss_status dagilimi kontrol edilmeli. Kalan: AC5 veritabanlari arasi pgss kesfi, AC7 test matrisi, AC11 katalog fail-fast, AC12 to_jsonb maliyeti, AC13 PG18 olcumu, AC14 catalog_version kaniti. |
